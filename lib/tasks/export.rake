namespace :export do
  ...
  task :seeds_format => :environment do
    puts "# encoding: UTF-8"
    puts
    puts "# This file contains the record creation needed to seed the database with its default values."
    puts "# The data can then be loaded with rake db:seed (or created alongside the db with db:setup)."
    puts
